...
<br>
<br>
	<div class="main"  style='background: url(anh/cc.png) no-repeat;'>

     
    	<table id='formthongke'>
		<form name="thongke" method="post">
		  <tr>
                <th style='border:none;'>Tên nhóm</th>
                <td><input type='text' name='group_name' id='group_name' value="<?php echo$_POST["group_name"]?>" style=' margin-left: 20px; margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
            <tr>
                 <th style='border:none;'></th>
                    <td colspan="-1"><input type="submit" name='submit' value='Tạo chữ ký' style='background-color:#3889ec; margin-left: -50px;
                    margin-top: 50px; height: 50px; width: 100px;  cursor: pointer;  border: 2px solid #8eb2de;'>
                </td>
            </tr>
             <tr>
                <th style='border:none;'>Chữ ký phần 1</th>
                <td><input type='text' name='private_value' value="<?php echo $part_1 ?>" disabled style=' margin-left: 20px; margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>

            <tr>
                <th style='border:none;'>Chữ ký phần 2</th>
                <td><input type='text' name='private_value' value="<?php echo $part_2 ?>" disabled style=' margin-left: 20px; margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
            <tr>
                <th style='border:none;'>Khóa công khai</th>
                <td><input type='text' name='private_key' value="<?php echo $public_key?>" disabled style=' margin-left: 20px; margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
            <tr>
                <th style='border:none;'>Giá trị công khai</th>
                <td><input type='text' name='private_value' value="<?php echo $public_value  ?>" disabled style=' margin-left: 20px; margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
           
            <tr>
                <th style='border:none;'>Tham số Q</th>
                <td><input type='text' name='q' value="<?php echo $q ?>" disabled style=' margin-left: 20px; margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
