 ...
 ?>
  ...
  include "csdl.php";
	...
	if(($extension == "doc" || $extension == "docx") && $size<=$max_size){
		...
		echo "<script>alert('Chỉ hỗ trợ file doc hoặc docx và dung lượng không quá 10MB')</script>";
	}
	}
	}
	if(isset($_POST['back']))
...
<div class="search-form">
  ...
  <div class="searchform-wrapper"><input type="text" value="" name="s" id="s" placeholder="Tìm kiếm..." style=' height: 30px; width: 19%;'/>
...
<br>
<br>
	<div class="main" style="background: url('images/cc.jpg');background-size: 1400px 900px;">
