...
<br>
	...
	<table id='formthongke'>
		<form name="thongke" method="post">
            <tr>
                ...
                <td><input type='text' name='group_name' style=' margin-left: 20px; 
                    margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
			<tr>
				<th style='border:none;'>Khóa bí mật</th>
				<td><input type='text' name='private_key' style=' margin-left: 20px; 
                    margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
			</tr>
			<tr>
				<th style='border:none;'>Giá trị bí mật</th>
				<td><input type='text' name='private_value' style=' margin-left: 20px; 
                    margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
			</tr>

            <tr>
                <td colspan=2>
                    <input type="submit" name='submit' value='OK' style='background-color:#3889ec; margin-left: 20px; 
    ...
    {
        userInitKey($_SESSION['username'], $_POST["group_name"], $_POST["private_key"], $_POST["private_value"]);
    }
?>
