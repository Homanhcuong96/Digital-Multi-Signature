...
<div id="lienhe">
 ...
 <p style=" font-size: 16px; font-family: sans-serif; color: black;">Hotline: 1234567890</p>
...
<br>
	...
	<h4 style="margin-top: 40px; font-size:25px; color: #030119;">Quản trị tài liệu</h4>
...
theToggle.onclick = function() {
   ...
   return false;
	...
	<div class='data'>
		<table id="gtquantri" style='width:930px;'>
		<tr>
		<th>Tên tài liệu</th>
		<th>Danh mục</th>
		<th>Người đăng</th>
...
<script>
function xoatl()
{return confirm('Bạn sẽ xóa các thông tin liên quan đến tài liệu này?');}
</script>
</html>