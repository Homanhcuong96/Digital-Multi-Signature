...
<br>
	...
	<table id='formthongke'>
		<form method="post" action='nhom.php' enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td><input type='text' name='group_name' id='group_name' style=' margin-left: 20px; 
                    margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>

			<tr>
                <td colspan=2>
    				<input type="submit" name='createGroup' onclick='handleCreateGroup()' value='Tạo nhóm' style='background-color:#3889ec; margin-left: 20px; 
    				margin-top: 20px; height: 50px; width: 100px; cursor: pointer;  border: 2px solid #8eb2de;'>
    				</td>
			</tr>
		</form>
	</table>
...
function handleCreateGroup() {
    return confirm('Đồng ý tạo nhóm?');
}
</script>
<?php
    ...
    {   
        ...
        createGroup($file, $_POST["group_name"]);
    }
?>
	</div>
	<br>
