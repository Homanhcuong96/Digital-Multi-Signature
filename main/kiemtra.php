...
<br>
    ...
    <table id='formthongke'>
        <form method="post" action='kiemtra.php' enctype="multipart/form-data">
            
            <tr>
                <th style='border:none;'>Chọn tệp</th>
                <td><input type='file' name='file' style=' margin-left: 20px; 
                margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
            <tr>
                <th style='border:none;'>Chữ ký phần 1</th>
                <td><input type='text' name='part_1' id='group_name' style=' margin-left: 20px; 
                margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
             <tr>
                <th style='border:none;'>Chữ ký phần 2</th>
                <td><input type='text' name='part_2' id='group_name' style=' margin-left: 20px; 
                margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
            <tr>
                <th style='border:none;'>Khóa công khai</th>
                <td><input type='text' name='public_key' id='group_name' style=' margin-left: 20px; 
                margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
             <tr>
                <th style='border:none;'>Giá trị công khai</th>
                <td><input type='text' name='public_value' id='group_name' style=' margin-left: 20px; 
                margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
            <tr>
                <th style='border:none;'>Tham số Q</th>
                <td><input type='text' name='q' id='group_name' style=' margin-left: 20px; 
                margin-top: 20px; width: 275px; height: 36px; border-radius: 5px; background: white;'></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan=1>
                <input type="submit" name='submit' value='Kiểm tra' style='background-color:#3889ec; margin-left: -50px; 
...
<?php
    ...
    {
        $file = $_FILES['file']['tmp_name'] or die("Unable to open file!");
        $hash_digest = get_hash_digest($file);
        ...
        $q = $_POST["q"];
        verify_integrity($part_1, $part_2, $public_key, $public_value, $q, $hash_digest);
    }
?>

<script> 
function handleCreateGroup() {
    return confirm('Create group?');
}
</script>
<?php
    if(isset($_POST["createGroup"]))  
    {
        createGroup($_POST["hash_value"], $_POST["group_name"]);
    }
?>
    </div>
    <br>
